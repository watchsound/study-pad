...
- (void)addLeftBarButtonItems {
    ...
    backbutton.imageView.image = [UIImage imageNamed:@"reveal-icon"];
    [backbutton addTarget:self action:@selector(buttonBackAction:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [self.navigationItem setLeftBarButtonItems:@[barButtonBack, barButtonLabel, fixedItem, barButtonToday]];
}
