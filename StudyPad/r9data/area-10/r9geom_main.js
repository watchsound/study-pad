...
var R9TransitionChainHandler = function(prefix){
    var This = this; 
	this.prefx = prefix || '';
    ...
    this.processCurrentStep = function(){
	    ...
	    if ( This.chain[This.currentStep].func.blockanimation  ){
	    	 window.PageBus.publish( prefix + 'r9.core.animation.stop', { 'messageid' : -1 });
	    	 return;
	    } 
	...
	this.showMessage = function(dnclayer, messageid, message, stagewidth, stageheight, duration, resumeAnimation){
	     window.PageBus.publish( prefix +'r9.core.animation.stop', { 'messageid' : messageid });
	  ...
	  if (duration > 0 ){
		 ...
		 var tween =  new Kinetic.Tween({
			 ...
			 onFinish: function() { 
                     ...
                     if ( resumeAnimation )
					     window.PageBus.publish( prefix +'r9.core.animation.resume', { 'messageid' : messageid });
				}
			}) ;
		  tween.play();
	...
	this.showDialog = function(dnclayer, messageid, title, message1, message2, message3, follow, stagewidth, stageheight, duration, resumeAnimation){
	     window.PageBus.publish( prefix +'r9.core.animation.stop', { 'messageid' : messageid });
     ...
     dialog.on('tap', function() {  
  	       dialog.remove();
		   This.showMessage(dnclayer, messageid,  follow, stagewidth, stageheight, duration, resumeAnimation);
       });  
	...
	this.showDialog2 = function(dnclayer, messageid, title, message1, follow1, message2, follow2, message3, follow3, stagewidth, stageheight, duration, resumeAnimation){
	     window.PageBus.publish(prefix + 'r9.core.animation.stop', { 'messageid' : messageid });
	     var fontsize = stagewidth > 500 ? 18 :15;
...
// add a tag to the label 
	     ...
	     label1.on('click tap', function() {
	    	 ...
	    	 label3.remove();
	    	 if ( follow1 )
	    	     This.showMessage(dnclayer, messageid,  follow1, stagewidth, stageheight, duration, resumeAnimation);
	     });
        ...
        _y += 50;
	     ...
	     label2.on('click tap', function() {
	    	 ...
	    	 label3.remove();
	    	 if ( follow2 )
	    	     This.showMessage(dnclayer, messageid,  follow2, stagewidth, stageheight, duration, resumeAnimation);
	     });
	     ...
	     label3.on('click tap', function() {
	    	 ...
	    	 label3.remove();
	    	 if ( follow3 )
	    	     This.showMessage(dnclayer, messageid,  follow3, stagewidth, stageheight, duration, resumeAnimation);
	     });
