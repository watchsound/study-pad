(function() {
 ...
 (function() {
   ...
   * var star = new Kinetic.R9Checkbox({
   *   startX: 100,
   *   startY: 100,
   *   endX: 200,
   *   endY:  200,
  ...
  // Kinetic.Factory.addGetterSetter(Kinetic.R9Checkbox, 'endX', 0);
  // Kinetic.Factory.addGetterSetter(Kinetic.R9Checkbox, 'endY', 0);
  Kinetic.Factory.addGetterSetter(Kinetic.R9Checkbox, 'checked', 0);
  Kinetic.Factory.addGetterSetter(Kinetic.R9Checkbox, 'stroke', 'black');
